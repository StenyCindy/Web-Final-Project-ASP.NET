<%@ Page Title="" Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="Beverages.aspx.cs" Inherits="pandanhouse.WebForm10" %>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active text-white" href="Beverages.aspx">Beverages</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
      ...
      <div class="row">
        <div class="col sm-6">
          <div class="container-fluid text-end  mt-4">
            <img src="images/drink.jpg" class="menu_image" width="500px" alt="">
          </div>
        </div>
        <div class="col sm-6">
          <div class="container-fluid">
            <img src="images/halal.png" alt="" width="80px" style="display: inline-block;">
            <h1 class="text-success mt-5 ms-1" style="display: inline-block;">Hot and Cold Drinks</h1>
          </div>
          <div class="container-fluid">
            <div class="border border-bottom mt-3"></div>
          </div>
          <div class="container-fluid mt-4">
            <p><b><u>Pilihan Menu Hot Drinks:</u></b></p>
            <p class="ms-5">
                - Jeruk Manis Panas <br>
                - Teh Susu Panas <br>
                - Teh Manis Hangat <br>
                - Cappucino Panas <br>
                - Kopi Susu <br>
            ...
            <br>
            <p><b><u>Pilihan Menu Cold Drinks:</u></b></p>
            <p class="ms-5">
                - Es Jeruk Manis <br>
                - Es teh susu <br>
                - Es teh manis <br>
