<%@ Page Title="" Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="Dessert.aspx.cs" Inherits="pandanhouse.WebForm8" %>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active text-white" href="Dessert.aspx">Dessert</a></li>
      ...
      <div class="row">
        <div class="col sm-6">
          <div class="container-fluid text-end  mt-4">
            <img src="images/dessert.jpg" class="menu_image" width="500px" alt="">
          </div>
        </div>
        <div class="col sm-6">
          <div class="container-fluid">
            <img src="images/halal.png" alt="" width="80px" style="display: inline-block;">
            <h1 class="text-success mt-5 ms-1" style="display: inline-block;">Dessert</h1>
          </div>
          <div class="container-fluid">
            <div class="border border-bottom mt-3"></div>
          </div>
          <div class="container-fluid mt-4">
            <p><b><u>Pilihan Menu Dessert:</u></b></p>
            <p class="ms-5">
                - Pisang Goreng Wijen <br>
                - Pisang Goreng Original <br>
                - Pisang Goreng Keju <br>
                - Pisang Goreng Coklat Keju <br>
                - Singkong Thailand <br>
                - Singkong Goreng Original <br>
                - Singkong Goreng Keju <br>
                - Empek-Empek <br>
                - Puding Coklat <br>
                - Puding Strawberry <br>
            </p> 
          </div>
        </div>
      </div>
