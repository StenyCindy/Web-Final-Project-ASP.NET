<%@ Page Title="" Language="C#" MasterPageFile="~/MainPage.Master" AutoEventWireup="true" CodeBehind="Fish.aspx.cs" Inherits="pandanhouse.WebForm7" %>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active text-white" href="Fish.aspx">Fish</a></li>
      ...
      <div class="row">
        <div class="col sm-6">
          <div class="container-fluid text-end  mt-4">
            <img src="images/fish.jpg" class="menu_image" width="500px" alt="">
          </div>
        </div>
        <div class="col sm-6">
          <div class="container-fluid">
            <img src="images/halal.png" alt="" width="80px" style="display: inline-block;">
            <h1 class="text-success mt-5 ms-1" style="display: inline-block;">Fish</h1>
          </div>
          <div class="container-fluid">
            <div class="border border-bottom mt-3"></div>
          </div>
          <div class="container-fluid mt-4">
            <p><b><u>Pilihan Menu Fish:</u></b></p>
            <p class="ms-5">
                - Ikan Gurame Asam Manis <br>
                - Ikan Gurane Saos Thailand <br>
                - Ikan Gurame Lada Garam <br>
                - Ikan Gurame Saos Telur Asin <br>
                - Ikan Gurame Goreng Terbang <br>
                - Ikan Kakap Asam Manis <br>
                - Ikan Kakap Saos Thailand <br>
                - Ikan Kakap Lada Garam <br>
                - Ikan Kakap Tim Hongkong <br>
                - Ikan Kakap Tahu Tausi <br>
                - Ikan Kerapu Tim Hongkong <br>
                - Ikan Kerapu Tahu Tausi <br>
            </p> 
          </div>
        </div>
      </div>
